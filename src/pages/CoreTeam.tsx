...
const CoreTeam = () => {
  ...
  const timeline = [
    { step: 1, title: "Applications Open", date: "August 1-15, 2025", status: "upcoming" },
    { step: 2, title: "Application Review", date: "August 16-20, 2025", status: "upcoming" },
    { step: 3, title: "Interviews & Selection", date: "August 21-25, 2025", status: "upcoming" },
    { step: 4, title: "Results Announced", date: "August 30, 2025", status: "upcoming" }
  ];
      ...
      <section className="py-16 px-4 bg-gradient-card">
        <div className="container mx-auto text-center">
          ...
          <div className="text-sm text-muted-foreground mb-8">
            <strong>Application Deadline:</strong> August 15, 2025 | <strong>Questions?</strong> Reach out to us on Instagram or email
          </div>
